...
ggplot(taxa_link_biomet_sum, aes(y = log((pos_sig+1)/(neg_sig+1)), x = factor(taxa_order, levels = c("Bats", "Birds", "Small mammals", "Amphibians")), 
  ...
  geom_hline(yintercept = 0, alpha = 0.5, size = 0.8) + ylim(c(-2,2)) +
...
sm_rich_slope <- subset(taxa_link_rich_slope, taxa_order == "Small mammals") # taxa_link_rich_slope not found... 
...
>>>>>>> cd2f14f4ce3109a711342c79877fee1456317f14
