...
emmeans::emmeans(sum_mods_cat_list[[sig_mods[1]]], pairwise~"continent")$contrasts
 # Africa - Americas            -0.0899 0.721 26 -0.125  0.9915 
 # Africa - Asia and Oceania     1.1030 0.739 26  1.492  0.3112 
 # Americas - Asia and Oceania   1.1929 0.377 26  3.166  0.0106      # Bird richness in the Americas is more upwardly stratified than Asia and Oceania 
...
=======
#  Dry - Sampling combined    1.268 0.413 26  3.071  0.0133 
#  Dry - Wet                 -0.386 0.460 26 -0.840  0.6819 
#  Sampling combined - Wet   -1.655 0.349 26 -4.740  0.0002 
>>>>>>> 1a99e26e02d7257d9e65cb78d9b8dfeb0e468be2


emmeans::emmeans(sum_mods_cat_list[[sig_mods[3]]],  pairwise~"forest_type_iucn")$contrasts
 # contrast                                    estimate    SE df t.ratio p.value
 # dry_forest - moist_lowland_forest             -0.595 0.458 26 -1.301  0.4072 
 # dry_forest - moist_montane_forest              0.820 0.430 26  1.908  0.1565 
 # moist_lowland_forest - moist_montane_forest    1.416 0.415 26  3.409  0.0059  # Bird richness in the moist lowland forest is more upwardly stratified than moist montane forest

emmeans::emmeans(sum_mods_cat_list[[sig_mods[4]]], pairwise~"continent")$contrasts
 # Africa - Americas            -0.0899 0.721 26 -0.125  0.9915 
 # Africa - Asia and Oceania     1.1030 0.739 26  1.492  0.3112 
 # Americas - Asia and Oceania   1.1929 0.377 26  3.166  0.0106 
...
emmeans::emmeans(sum_mods_cat_list[[sig_mods[6]]], pairwise~"forest_type_iucn")$contrasts
 # dry_forest - moist_lowland_forest             -0.595 0.458 26 -1.301  0.4072 
 # dry_forest - moist_montane_forest              0.820 0.430 26  1.908  0.1565 
 # moist_lowland_forest - moist_montane_forest    1.416 0.415 26  3.409  0.0059   # Bird abundance in the moist lowland forest is more upwardly stratified than moist montane forest
