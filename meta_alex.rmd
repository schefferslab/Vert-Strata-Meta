...
emmeans::emmeans(sum_mods_cat_list[[8]],  pairwise~season)$contrasts
 # contrast                estimate    SE df t.ratio p.value
 # Dry - Sampling combined    1.099 0.375 26  2.929  0.0185
 # Dry - Wet                 -0.364 0.418 26 -0.871  0.6633 
 # Sampling combined - Wet   -1.463 0.317 26 -4.611  0.0003 
...
tables_S1 = unique(dat_table[,c( "reference","link", "taxa", "weight", "continent" , "latitude", "longitude", "elevation", "forest_type_iucn", "canopy_height", "season")])
...
# rename columns
colnames(full_table_S1) = c( "Reference","Study Unit", "Taxa", "Study Quality", "Bioregion" , "Latitude", "Longitude", "Elevation", "Forest Type", "Canopy Height", "Season", "Richness", "Abundance")
