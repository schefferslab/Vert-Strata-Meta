...
# 
# packages <- c("lme4","AICcmodavg","glmmTMB","TMB","tidyverse","readr","scales","formula.tools","sjPlot","ggpubr","scales","Hmisc","visreg","bbmle")
# 
...
dat <- read_csv("data/stripped_data/final/data_joined.csv") %>%
  ...
  dplyr::mutate(composite_weight = as.numeric(bin_weight*rescale(weight, to = c(0,1))*indepedence_weight)) 

test <- scale(dat$composite_weight, center = T) + 1
